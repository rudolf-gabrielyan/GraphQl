...
class MoviesForm extends React.Component {
  ...
  handleSave = () => {
    ...
    id ? updateMovie({ id, name, gener: genre, rate: Number(rate), directorId, watched: Boolean(watched) }) : addMovie({ name, gener: genre, rate: Number(rate), directorId, watched: Boolean(watched) });
    onClose();
  };
